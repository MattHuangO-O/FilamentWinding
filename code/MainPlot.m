...
plot3(circuit(1,:), yR_circuit, zR_circuit, 'b');
plot3(circuit(1,:), yL_circuit, zL_circuit, 'b');
axis('equal')
...
plot3(cycleR(1,:), cycleR(2,:), cycleR(3,:), 'b'); %out line
plot3(cycleL(1,:), cycleL(2,:), cycleL(3,:), 'b');
...
plot3(fullR(1,:), fullR(2,:), fullR(3,:), 'b'); %out line
plot3(fullL(1,:), fullL(2,:), fullL(3,:), 'b');
